...
urlpatterns = [
    ...
    path('jewelry/settings/stones/update/<int:id>',
         views.update_stones_settings, name="update-stones-settings"),
    ...
    path('jewelry/settings/pearls/update/<int:id>',
         views.update_pearls_settings, name="update-pearls-settings"),
    ...
    path('jewelry/settings/metals/update/<int:id>',
         views.MetalsUpdateView.as_view(), name="update-metals-settings"),
